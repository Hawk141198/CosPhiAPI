...
function calcAllValues(device){
    ...
    if(device.p != null && device.cosphi != null){
        ...
        throw "Das Gerät " + device + " ist fehlerhaft! Es muss mindestens der cosPhi und einer der Werte von Wirkleistung (p), Scheinleistung (s) und Blindleistung (q) angegeben sein.";
    }
 ...
 * @param {Object} deviceDistribution Verteilung der Geräte auf den Phasen im Format: {L1: [.. , ..], L2: [.. , ..], L3: [.. , ..]}
 */
...
console.log(getPhaseValues(deviceDistributionSinglePhase));